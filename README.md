...
```kotlin
dependencies {
    implementation("com.github.Releazio:releazio-sdk-android:1.0.5")
}
```
...
> **Примечание:** При вызове `Releazio.configure()` SDK автоматически отправляет информацию об устройстве на сервер для статистики API запросов. Это происходит в фоне и не блокирует инициализацию SDK. Ошибки при отправке данных не прерывают процесс инициализации.
